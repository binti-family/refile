  ...
  module AttachmentHelper
    ...
    module FormBuilder
      ...
      def attachment_field(method, options = {})
        self.multipart = true
        @template.attachment_field(@object_name, method, object: @object, **objectify_options(options))
      end

      # @see AttachmentHelper#attachment_cache_field
      def attachment_cache_field(method, options = {})
        self.multipart = true
        @template.attachment_cache_field(@object_name, method, object: @object, **objectify_options(options))
      end
    end
